...
// Creating an easterEgg function to handle supriseElement logics
function easterEgg() {
  update(locations[7]);
}

// Creating functions to facilitate pick logics
function pickTwo() {
 pick(2);
}
...
// Creating a pick function to handle pickingSuprises logics through guess parameters
function pick(guess) {
  const numbers = [];
